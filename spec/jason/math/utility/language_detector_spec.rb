RSpec.describe Jason::Math::Utility::LanguageDetector do
  context '#distance' do
    ...
    context 'english text, language = :english' do
      let(:text) do
        "What art thou that usurp'st this time of night, together with that fair and warlike form in which the majesty of buried Denmark did sometimes march? by heaven I charge thee, speak!".b
      end
